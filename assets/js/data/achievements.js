(function () {
  ...
  // against Crossref title records on 2026-08-17; rows without a DOI remain linkless.
  var publicationRows = [
    ["scfnsa-single-cell-multi-omics-2026", "2026", "scFNSA: A Factorized Node-Set Attentive Framework for Single-Cell Multi-Omics Integration", "Shoujia Jiang, Junliang Shang, Defu Qiu, Hanxiang Wang, Jin-Xing Liu", "Journal of Chemical Information and Modeling, 66, 5558-5572", "10.1021/acs.jcim.6c00448"],
    ...
    ["ct-denoimer-2025", "2025", "CT-Denoimer: efficient contextual transformer network for low-dose CT denoising", "Yuanke Zhang, Fan Xu, Rui Zhang, Yanfei Guo, Hanxiang Wang, Bingbing Wei, Fei Ma, Jing Meng, Jianlei Liu, Hongbing Lu, Yang Chen", "Physics in Medicine & Biology, 70, 115024", "10.1088/1361-6560/addea6"],
    ...
    ["plant-disease-review-2024", "2024", "Computer vision for plant disease recognition: a comprehensive review", "Minh Dang, Hanxiang Wang, Yanfen Li, Tri-Hai Nguyen, Lilia Tightiz, Nguyen Xuan-Mung, Tan N. Nguyen", "The Botanical Review, 90, 251-311", "10.1007/s12229-024-09299-z"],
    ...
    ["regnet-sewer-defect-2023", "2023", "Deep learning based underground sewer defect classification using a modified RegNet", "Yu Chen, ASMS Sagar, Hanxiang Wang, Yanfen Li, L. Dang, Hyoung-Kyu Song, Hyeonjoon Moon", "Computers, Materials, & Continua, 75, 5455", "10.32604/cmc.2023.033787"],
    ...
    ["attention-sewer-pipeline-2023", "2023", "Attention-guided multiscale neural network for defect detection in sewer pipelines", "Yanfen Li, Hanxiang Wang, L. Minh Dang, Hyoung-Kyu Song, Hyeonjoon Moon", "Computer-Aided Civil and Infrastructure Engineering, 38, 2163-2179", "10.1111/mice.12991"],
    ...
    ["heat-network-usage-2022", "2022", "Daily and seasonal heat usage patterns analysis in heat networks", "L. Minh Dang, Sujin Lee, Yanfen Li, Chanmi Oh, Tan N. Nguyen, Hyoung-Kyu Song, Hyeonjoon Moon", "Scientific Reports, 12, 9165", "10.1038/s41598-022-13030-6"],
